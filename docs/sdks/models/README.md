...
* [openRouterModelsList](#openroutermodelslist) - OpenRouter models listing endpoint
...
```typescript
import { AtomaSDKCore } from "atoma-sdk/core.js";
import { modelsOpenRouterModelsList } from "atoma-sdk/funcs/modelsOpenRouterModelsList.js";
...
async function run() {
  const res = await modelsOpenRouterModelsList(atomaSDK);

# ConfidentialCompletions
(*confidentialCompletions*)

## Overview

Atoma's API confidential completions v1 endpoint
...
import { confidentialCompletionsCreate } from "atoma-sdk/funcs/confidentialCompletionsCreate.js";
...
async function run() {
  const res = await confidentialCompletionsCreate(atomaSDK, {
    ciphertext: "<value>",
    clientDhPublicKey: "<value>",
    modelName: "<value>",
    nodeDhPublicKey: "<value>",
...
async function run() {
  const result = await atomaSDK.confidentialCompletions.createStream({
    ciphertext: "<value>",
    clientDhPublicKey: "<value>",
    modelName: "<value>",
    nodeDhPublicKey: "<value>",
...
```typescript
import { AtomaSDKCore } from "atoma-sdk/core.js";
import { confidentialCompletionsCreateStream } from "atoma-sdk/funcs/confidentialCompletionsCreateStream.js";
...
async function run() {
  const res = await confidentialCompletionsCreateStream(atomaSDK, {
    ciphertext: "<value>",
    clientDhPublicKey: "<value>",
    modelName: "<value>",
    nodeDhPublicKey: "<value>",
...
**Promise\<[EventStream<operations.ConfidentialCompletionsCreateStreamResponseBody>](../../models/.md)\>**
